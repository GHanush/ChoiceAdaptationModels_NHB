...
## Instructions to use
Navigate to subfolder 'losspar' to run model fitting to data of any one participant in Experiment 3
Follow instructions to use in file 'README.md' in subfolder 'losspar'.
