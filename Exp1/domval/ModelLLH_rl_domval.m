function [LLH] = ModelLLH_rl_domval(param)
LLH = 0;           
...
for b = 1:4 % loop over blocks
    if b == 1
        par = [0,param(1),param(2),0,param(3),param(4),0];
    elseif b == 2
        par = [0,param(5),param(6),0,param(7),param(8),0];
    elseif b == 3
        par = [0,param(9),param(10),0,param(11),param(12),0];
    elseif b == 4
        par = [0,param(13),param(14),0,param(15),param(16),0];
    end
